    ...
    <PublicRoute>
      <div className="min-h-screen w-full flex bg-background">
        ...
        <div className="hidden lg:flex w-1/2 relative bg-primary/5 items-center justify-center p-12 overflow-hidden border-r border-card-border">
          ...
          <div className="relative z-10 max-w-lg">
            ...
            <p className="text-lg text-text-muted leading-relaxed">
              Streamline your workflow, collaborate seamlessly with your team,
              and deliver every project on time with our Smart Collaboration
              System.
            </p>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center relative overflow-hidden p-4 sm:p-8">
          ...
          <div
            className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-primary/20 blur-[100px] pointer-events-none animate-pulse"
            style={{ animationDelay: "2s" }}
          ></div>

          <div className="w-full max-w-md p-8 sm:p-10 rounded-3xl glass-card relative z-10 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10">
            ...
            <div className="space-y-4 mb-6">
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 px-4 rounded-xl bg-primary/10 text-primary border border-primary/20 font-bold hover:bg-primary hover:text-white active:scale-[0.98] transition-all duration-200 disabled:opacity-70 flex items-center justify-center gap-3 uppercase tracking-wider text-sm"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm px-1">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="rounded text-primary focus:ring-primary/20 border-input-border bg-input-bg"
                  />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 mt-2 rounded-xl bg-primary text-white font-medium hover:bg-primary-hover focus:ring-4 focus:ring-primary/30 active:scale-[0.98] transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-primary/25"
              >
                {loading ? (
